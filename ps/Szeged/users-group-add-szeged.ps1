...
foreach ($user in $users) {
    try {
        ...
        $userPrincipalName = "$username@szeged.kkk.com"
        ...
        if ($ouPath -like "*OU=Alkalmazott*") {
            $groupOU = "OU=Csoportok,OU=Alkalmazott,DC=szeged,DC=kkk,DC=com"
        } elseif ($ouPath -like "*OU=Vezeto*") {
            $groupOU = "OU=Csoportok,OU=Vezeto,DC=szeged,DC=kkk,DC=com"
        } elseif ($ouPath -like "*OU=IT*") {
            $groupOU = "OU=Csoportok,OU=IT,DC=szeged,DC=kkk,DC=com"
        } else {
