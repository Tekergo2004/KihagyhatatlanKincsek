...
$ouk = @(@("Felhasznalok", "DC=debrecen,DC=kkk,DC=com"), @("Vezeto", "OU=Felhasznalok,DC=debrecen,DC=kkk,DC=com"), @("IT", "OU=Felhasznalok,DC=debrecen,DC=kkk,DC=com"), @("Alkalmazott", "OU=Felhasznalok,DC=debrecen,DC=kkk,DC=com"), @("Fiokvezeto", "OU=Felhasznalok,DC=debrecen,DC=kkk,DC=com"), @("Tehetseg", "OU=Felhasznalok,,DC=debrecen,DC=kkk,DC=com"), @("Kiado", "OU=Felhasznalok,DC=debrecen,DC=kkk,DC=com"), @("Csoportok", "OU=Felhasznalok,,DC=debrecen,DC=kkk,DC=com"))
